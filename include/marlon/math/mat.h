...
public:
  static constexpr auto zero() noexcept {
    return Rvec<T, 2>{T(0), T(0)};
  }

  Rvec() = default;

  constexpr Rvec(T x, T y) noexcept
      : _components{x, y} {}
...
public:
  static constexpr auto zero() noexcept {
    return Rvec<T, 3>{T(0), T(0), T(0)};
  }

  Rvec() = default;

  constexpr Rvec(T x, T y, T z) noexcept
      : _components{x, y, z} {}

  constexpr Rvec(Rvec<T, 2> xy, T z) noexcept
      : _components{xy[0], xy[1], z} {}

  constexpr Rvec(T x, Rvec<T, 2> yz) noexcept
      : _components{x, yz[0], yz[1]} {}
...
public:
  ...
  constexpr Rvec(T x, T y, T z, T w) noexcept
      : _components{x, y, z, w} {}
...
public:
  ...
  static constexpr auto identity() noexcept {
    ...
    if constexpr (M == 3) {
      return Mat<T, 3, 3>{
          Rvec<T, 3>{T(1), T(0), T(0)},
          Rvec<T, 3>{T(0), T(1), T(0)},
          Rvec<T, 3>{T(0), T(0), T(1)},
      };
    } else {
      return Mat<T, 3, 4>{
          Rvec<T, 4>{T(1), T(0), T(0), T(0)},
  ...
  trs(Vec3<T> const &t, Quat<T> const &r, Vec3<T> const &s) noexcept {
    static_assert(M == 4);
    auto result = rigid(t, r);
    for (auto i = 0; i < 3; ++i) {
      for (auto j = 0; j < 3; ++j) {
...
using Rvec2i8 = Rvec2<std::int8_t>;
using Rvec3i8 = Rvec3<std::int8_t>;
using Rvec4i8 = Rvec4<std::int8_t>;
using Rvec2u8 = Rvec2<std::uint8_t>;
using Rvec3u8 = Rvec3<std::uint8_t>;
using Rvec4u8 = Rvec4<std::uint8_t>;
using Rvec2i16 = Rvec2<std::int16_t>;
using Rvec3i16 = Rvec3<std::int16_t>;
using Rvec4i16 = Rvec4<std::int16_t>;
using Rvec2u16 = Rvec2<std::uint16_t>;
using Rvec3u16 = Rvec3<std::uint16_t>;
using Rvec4u16 = Rvec4<std::uint16_t>;
using Rvec2i32 = Rvec2<std::int32_t>;
using Rvec3i32 = Rvec3<std::int32_t>;
using Rvec4i32 = Rvec4<std::int32_t>;
using Rvec2u32 = Rvec2<std::uint32_t>;
using Rvec3u32 = Rvec3<std::uint32_t>;
using Rvec4u32 = Rvec4<std::uint32_t>;
...
using Mat2x2i8 = Mat<std::int8_t, 2, 2>;
using Mat2x3i8 = Mat<std::int8_t, 2, 3>;
using Mat2x4i8 = Mat<std::int8_t, 2, 4>;
using Mat3x2i8 = Mat<std::int8_t, 3, 2>;
using Mat3x3i8 = Mat<std::int8_t, 3, 3>;
using Mat3x4i8 = Mat<std::int8_t, 3, 4>;
using Mat4x2i8 = Mat<std::int8_t, 4, 2>;
using Mat4x3i8 = Mat<std::int8_t, 4, 3>;
using Mat4x4i8 = Mat<std::int8_t, 4, 4>;
using Mat2x2u8 = Mat<std::uint8_t, 2, 2>;
using Mat2x3u8 = Mat<std::uint8_t, 2, 3>;
using Mat2x4u8 = Mat<std::uint8_t, 2, 4>;
using Mat3x2u8 = Mat<std::uint8_t, 3, 2>;
using Mat3x3u8 = Mat<std::uint8_t, 3, 3>;
using Mat3x4u8 = Mat<std::uint8_t, 3, 4>;
using Mat4x2u8 = Mat<std::uint8_t, 4, 2>;
using Mat4x3u8 = Mat<std::uint8_t, 4, 3>;
using Mat4x4u8 = Mat<std::uint8_t, 4, 4>;
using Mat2x2i16 = Mat<std::int16_t, 2, 2>;
using Mat2x3i16 = Mat<std::int16_t, 2, 3>;
using Mat2x4i16 = Mat<std::int16_t, 2, 4>;
using Mat3x2i16 = Mat<std::int16_t, 3, 2>;
using Mat3x3i16 = Mat<std::int16_t, 3, 3>;
using Mat3x4i16 = Mat<std::int16_t, 3, 4>;
using Mat4x2i16 = Mat<std::int16_t, 4, 2>;
using Mat4x3i16 = Mat<std::int16_t, 4, 3>;
using Mat4x4i16 = Mat<std::int16_t, 4, 4>;
using Mat2x2u16 = Mat<std::uint16_t, 2, 2>;
using Mat2x3u16 = Mat<std::uint16_t, 2, 3>;
using Mat2x4u16 = Mat<std::uint16_t, 2, 4>;
using Mat3x2u16 = Mat<std::uint16_t, 3, 2>;
using Mat3x3u16 = Mat<std::uint16_t, 3, 3>;
using Mat3x4u16 = Mat<std::uint16_t, 3, 4>;
using Mat4x2u16 = Mat<std::uint16_t, 4, 2>;
using Mat4x3u16 = Mat<std::uint16_t, 4, 3>;
using Mat4x4u16 = Mat<std::uint16_t, 4, 4>;
using Mat2x2i32 = Mat<std::int32_t, 2, 2>;
using Mat2x3i32 = Mat<std::int32_t, 2, 3>;
using Mat2x4i32 = Mat<std::int32_t, 2, 4>;
using Mat3x2i32 = Mat<std::int32_t, 3, 2>;
using Mat3x3i32 = Mat<std::int32_t, 3, 3>;
using Mat3x4i32 = Mat<std::int32_t, 3, 4>;
using Mat4x2i32 = Mat<std::int32_t, 4, 2>;
using Mat4x3i32 = Mat<std::int32_t, 4, 3>;
using Mat4x4i32 = Mat<std::int32_t, 4, 4>;
using Mat2x2u32 = Mat<std::uint32_t, 2, 2>;
using Mat2x3u32 = Mat<std::uint32_t, 2, 3>;
using Mat2x4u32 = Mat<std::uint32_t, 2, 4>;
using Mat3x2u32 = Mat<std::uint32_t, 3, 2>;
using Mat3x3u32 = Mat<std::uint32_t, 3, 3>;
using Mat3x4u32 = Mat<std::uint32_t, 3, 4>;
using Mat4x2u32 = Mat<std::uint32_t, 4, 2>;
using Mat4x3u32 = Mat<std::uint32_t, 4, 3>;
using Mat4x4u32 = Mat<std::uint32_t, 4, 4>;
